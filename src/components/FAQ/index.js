...
export default function FAQ() {
  ...
  return (
    <div className='faq center container-flud'>
              ...
              <div className='question__content' onClick={() => visibleAnswer1()}>
                ...
                <Collapse isOpen={showAnswer1}>
                  <p className='answer'>
                    ...
                    developing practical and innovative technological solutions to enable a seamless
                    web3 NFT economy. For more information on Mochilab.org, please visit{' '}
              ...
              <div className='question__content' onClick={() => visibleAnswer2()}>
                ...
                <Collapse isOpen={showAnswer2}>
                  <p className='answer'>
                    ...
                    for non-fungible tokens (“NFT”). For more information on how we plan to achieve
                    this aim, please visit our{' '}
          ...
          <div className='item col-12 col-md-8'>
            <div className='question'>
              <div className='question__content' onClick={() => visibleAnswer8()}>
                <p className='title-question'>What does it offer to the users? / Product Suites</p>
                <img
                  width='25px'
                ...
                <Collapse isOpen={showAnswer8}>
                  <p className='answer'>
                    Mochi Marketplace - Where people can buy, sell, exchange peer-to-peer, lending,
                    and borrow peer-to-peer through an exchange like a traditional exchange.
                    <br />
                    <br />
                    ...
                    passive profits by providing NFT and FT liquidity for the services of the Mochi
                    Market ecosystem.
                    <br />
                    <br />
              ...
              <div className='question__content' onClick={() => visibleAnswer11()}>
                ...
                <Collapse isOpen={showAnswer11}>
                  <p className='answer'>
                    ...
                    of our product development so that users can freely buy, sell, and exchange NFTs
                    as well as use other services between multiple chains easily and transparently.
                    <br />
                    <br />
                    We will launch our product first on BSC in order to take advantage of its active
                    and growing ecosystems, as well as the low transaction fees and fast transaction
                    time on BSC. In the near future, our product will be deployed on Harmony, and
                    other chains such Ethereum, Cosmos, Polkadot, Solana, Near Protocol and other
                    blockchains, allowing users to tap into various blockchain ecosystems.
                  </p>
                </Collapse>
              </div>
            </div>
            ...
            <div className='question'>
              <div className='question__content' onClick={() => visibleAnswer12()}>
                ...
                <Collapse isOpen={showAnswer12}>
                  <p className='answer'>
                    As we are warming up to opening our doors, we would like to reward and encourage
                    early testers and adopters for giving our service a try. This will help us to
                    gather feedback and improve. An NFT will be considered similar to a lottery
                    ticket. Everyone who holds an NFT will be able to take part in the airdrop
                    campaign. Only NFT holders will be able to claim the airdrop. For more info on
                    the first{' '}
                    <a
