...
export default function PrivacyPolicyAndTermsConditions() {
  return (
    <div className='privacy-terms-conditions center container-flud'>
      <div className='row justify-content-center'>
        <div className='content col-12 col-md-10'>
          <h2>Privacy Policy & Terms and Conditions</h2>
          <p>
            MochiLab (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy
          ...
          <p>
            ...
            our “Service”) alongside our application, MochiLab. By accessing or using our Service,
          ...
          <ul>
            ...
            <li>
              ...
              MochiLab Foundation Ltd, (3 Fraser Street #5-25 Duo Tower, Singapore) that is
              responsible for your information under this Privacy Policy.
            </li>

            <li>
              Country: where MochiLab or the owners/founders of MochiLab are based, in this case is
              Singapore.
            </li>

            <li>
              Customer: refers to the company, organization or person that signs up to use the
              MochiLab Service to manage the relationships with your consumers or service users.
            </li>

            <li>
              Device: any internet connected device such as a mobile phone, tablet, computer or any
              other device that can be used to visit MochiLab and use their services.
            </li>
            ...
            <li>
              Personnel: refers to those individuals who are employed by MochiLab or are under
            ...
            <li>
              Service: refers to the service provided by MochiLab as described in the relative terms
            ...
            <li>Website: MochiLab."’s" site, which can be accessed via this URL: mochilab.org</li>

            <li>You: a person or entity that is registered with MochiLab to use the Services.</li>
          </ul>

          <strong>Information automatically collected</strong>

          <p>
            There is some information like your Internet Protocol (IP) address and/or browser and
          ...
          <p>
            If you are a MochiLab worker or applicant, we collect information you voluntarily
          ...
          <p>
            ...
            merger or other transfer of all or substantially all of the assets of MochiLab or any of
            its Corporate Affiliates (as defined herein), or that portion of MochiLab or any of its
          ...
          <p>
            ...
            control with MochiLab, whether by ownership or otherwise. Any information relating to
          ...
          <p>
            This Privacy Policy is governed by the laws of Singapore without regard to its conflict
          ...
          <p>
            The laws of Singapore, excluding its conflicts of law rules, shall govern this Agreement
            and your use of the website. Your use of the website may also be subject to other local,
            state, national, or international laws.
          </p>

          <p>
            By using MochiLab or contacting us directly, you signify your acceptance of this Privacy
          ...
          <p>
            We have updated our Privacy Policy to provide you with complete transparency into what
            is being set when you visit our site and how it's being used. By using our website,
          ...
          <p>
            ...
            other websites not operated or controlled by MochiLab. We are not responsible for the
          ...
          <p>
            ...
            MochiLab does not make any representation as to the accuracy or suitability of any of
            the information contained in those advertisements or sites and does not accept any
          ...
          <p>
            Advertising keeps MochiLab and many of the websites and services you use free of charge.
          ...
          <p>
            ...
            advertised are not endorsements or recommendations by MochiLab of the third-party sites,
            goods or services. MochiLab takes no responsibility for the content of any of the ads,
          ...
          <p>
            These cookies collect information over time about your online activity on the website
            and other online services to make online advertisements more relevant and effective to
            you. This is known as interest-based advertising. They also perform functions like
            preventing the same ad from continuously reappearing and ensuring that ads are properly
            displayed for advertisers. Without cookies, it’s really hard for an advertiser to reach
            its audience, or to know how many ads were shown and how many clicks they received.
          </p>

          <strong>Cookies</strong>
          <p>
            MochiLab uses "Cookies" to identify the areas of our website that you have visited. A
          ...
          <p>
            ...
            already visited your website. It allows your company to seem like they're “following”
          ...
          <p>
            You acknowledge and agree that MochiLab shall not be responsible for any Third-Party
            Services, including their accuracy, completeness, timeliness, validity, copyright
            compliance, legality, decency, quality or any other aspect thereof. MochiLab does not
          ...
          <ul>
            <li>
              Cookies: We use Cookies to enhance the performance and functionality of our website
            ...
            <li>
              Local Storage: Local Storage sometimes known as DOM storage, provides web apps with
              methods and protocols for storing client-side data. Web storage supports persistent
              data storage, similar to cookies but with a greatly enhanced capacity and no
              information stored in the HTTP request header.
            </li>
            <li>
              Sessions: MochiLab uses "Sessions" to identify the areas of our website that you have
              visited. A Session is a small piece of data stored on your computer or mobile device
              by your web browser.
            </li>
          </ul>
          ...
          <p>
            ...
            businesses and EU residents. Our customers’ data is important irrespective of where they
            are located, which is why we have implemented GDPR controls as our baseline standard for
          ...
          <p>
            ...
            simply the right thing to do. At MochiLab we strongly believe that your data privacy is
            very important and we already have solid security and privacy practices in place that go
            beyond the requirements of this new regulation.
          </p>

          <strong>Individual Data Subject's Rights - Data Access, Portability and Deletion</strong>
          <p>
            We are committed to helping our customers meet the data subject rights requirements of
            GDPR. MochiLab processes or stores all personal data in fully vetted, DPA compliant
          ...
          <ul>
            <li>
              Right to Know and Access. You may submit a verifiable request for information
          ...
          <p>
            Via Email: <a href='mailto:contact@mochilab.org'>contact@mochilab.org</a>
          </p>
        </div>
      </div>
    </div>
